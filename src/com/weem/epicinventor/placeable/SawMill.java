...
public class SawMill extends Building {
    ...
    public SawMill(PlaceableManager pm, Registry rg, String sm, String am, int x, int y, Placeable.State cs) {
    ...
    public void updateLong() {
        ...
        if(generationTimerEnd <= System.currentTimeMillis() && this.isActivated()) {
            placeableManager.playerAddItem("Wood", 1);
            registry.getIndicatorManager().createImageIndicator(mapX + (width / 2), mapY + height + 32, "Wood");
            registry.showMessage("Success", type + " has generated Wood");
            resetGenerationTimer();
        }
    }
}
